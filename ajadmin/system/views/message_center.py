...
from ajadmin.system.models import MessageCenter, Users, MessageCenterTargetUser
from ajadmin.utils.json_response import SuccessResponse, DetailResponse
from ajadmin.utils.serializers import CustomModelSerializer
from ajadmin.utils.viewset import CustomModelViewSet
...
class MessageCenterSerializer(CustomModelSerializer):
    ...
    def get_role_info(self, instance, parsed_query):
        ...
        from ajadmin.system.views.role import RoleSerializer
    ...
    def get_user_info(self, instance, parsed_query):
        ...
        # You can do what ever you want in here
        # `parsed_query` param is passed to BookSerializer to allow further querying
        from ajadmin.system.views.user import UserSerializer
    ...
    def get_dept_info(self, instance, parsed_query):
        ...
        # You can do what ever you want in here
        # `parsed_query` param is passed to BookSerializer to allow further querying
        from ajadmin.system.views.dept import DeptSerializer
...
class MessageCenterCreateSerializer(CustomModelSerializer):
    ...
    def save(self, **kwargs):
        ...
        if target_type in [3]:  # 系统通知
            ...
            websocket_push("ajadmin", message={"sender": 'system', "contentType": 'SYSTEM',
