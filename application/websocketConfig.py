...
def _get_message_center_instance(message_id):
    from ajadmin.system.models import MessageCenter
...
def _get_message_unread(user_id):
    """获取用户的未读消息数量"""
    from ajadmin.system.models import MessageCenterTargetUser
...
class DvadminWebSocket(AsyncJsonWebsocketConsumer):
    ...
    async def disconnect(self, close_code):
        ...
        await self.channel_layer.group_discard("ajadmin", self.channel_name)
        print("连接关闭")
        try:
